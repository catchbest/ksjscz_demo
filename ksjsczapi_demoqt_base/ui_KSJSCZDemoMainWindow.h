...
public:
    ...
    void setupUi(QDialog *KSJSCZDemoMainWindow)
    {
        ...
        UserInputGroupBox->setGeometry(QRect(836, -14, 425, 711));
        ...
        StartCapturePushButton->setGeometry(QRect(194, 288, 79, 31));
        ...
        StaticText_FPS->setGeometry(QRect(288, 296, 49, 16));
        ...
        FlipCheckBox->setGeometry(QRect(108, 296, 65, 16));
