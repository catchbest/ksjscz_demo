...
// Internal
KSJSCZ_API KSJSCZ_RdRegFPGA(int nSensorIndex, unsigned short usRegAddress, unsigned long *pulRegValue);
KSJSCZ_API KSJSCZ_WrRegFPGA(int nSensorIndex, unsigned short usRegAddress, unsigned long ulRegValue);
